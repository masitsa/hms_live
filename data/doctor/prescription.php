...
if(!empty($service_charge_id)){
	...
	$drug_size = mysql_result($rs2, $s, "drug_size");
	$drug_size_type = mysql_result($rs2, $s, "drug_size_type");
...
<body onLoad="patient_details(<?php echo $visit_id;?>)">
  <div id="header" class="container">
    	<div id="logo">
	    <h1><a href="#">SUMC</a></h1>
			<p><a href="http://www.strathmore.edu">Prescription</a></p>
		</div>
	</div>
...
<form name="myform" action="prescription.php?visit_id=<?php echo $visit_id?>" method="post">
                                    ...
                                    <table class='table table-striped table-hover table-condensed'>
                                        <tr>
                                        	<td>Medicine: </td>
                                        	<td><input type="text" name="passed_value" id="passed_value" size="60" onClick="myPopup2(<?php echo $visit_id;?>)" value="<?php echo $passed_value;?>"/> <a href="#" onClick="myPopup2(<?php echo $visit_id;?>)">Get Drug</a></td>
