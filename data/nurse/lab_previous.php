...
<body>
	...
	if($s%2 == 0){
		...
		?>
        <form action="lab_previous.php" method="POST">
        <tr  bgcolor="<?php echo $bgcolor ?>">
     <td><?php echo $lab_test_name?></td>
    <td><?php echo $lab_visit_result?></td>
    <td><?php echo $lab_test_units?></td>
	<td><?php echo $lab_test_malelowerlimit?></td>
    <td><?php echo $lab_test_malelupperlimit?></td>
    <td><?php echo $lab_test_femalelowerlimit?></td>
	<td><?php echo $lab_test_femaleupperlimit?></td>
	<td><?php echo $visit_time?></td>
        ...
        <?php } ?>
          ...
          <table align="center">
        		<tr>
            		<td><a href="lab_previous.php?id=<?php echo $previous_page; ?>" class="modify2"><img src="../../administration/images/back_alt.png"/></a></td>
            
            <?php
            
				for($t = 1; $t <= $num_pages; $t++){
					
					echo "<td width='10' ><a href='lab_previous.php?id=".$t."' class='modify'>".$t."</a></td>";
				}
			
			?>
            		<td><a href="lab_previous.php?id=<?php echo $next_page; ?>" class="modify2"><img src="../../administration/images/forward_alt.png"/></a></td>
           	  </tr>
            </table>
