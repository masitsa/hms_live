...
class save_med{
	function delete_med_check($cat_items_id,$format_id,$visit_id){
		$sql = "DELETE FROM medical_checkup_results where cat_id=$cat_items_id and format_id=$format_id and visit_id=$visit_id";
		//echo $sql;
		$save = new Database;
		$save->insert($sql);
...
$s = new save_med();
$s->delete_med_check($cat_items_id,$format_id,$visit_id);
