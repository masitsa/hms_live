<?php
session_start();
include ('../../classes/class_invoice.php');
...
$insurance_name=mysql_result($rsf, 0, 'insurance_company_name');
		...
		$this->Cell(0,5,'Invoice Date:	'.date("y-m-d"), 'B', 1, 'L');
	}
	else{
...
$rs = $get_charge->get_invoice_pres($vid,$visit_t);
$num_rows = mysql_num_rows($rs);
...
$pdf->Cell(45,$pageH,'Service Item','B');
