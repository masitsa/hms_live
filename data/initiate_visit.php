    ...
    <option >----Select Doctor to View Schedule---</option>
      ...
      <div  id="doctors_schedule"> 
        ...
        <input type="text" style="width: 70px" id="timepicker_end" name="timepicker_end" value="" />
                    	...
                    	<td>
                       <select name="patient_type" id="patient_type"  onChange='insurance_company("patient_type","insured");getCity("http://localhost/hms/data/load_charges.php?patient_type="+this.value);' >
