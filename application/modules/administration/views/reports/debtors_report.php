    ...
    <div class="col-md-12">
      ...
      <div class="widget boxed">
        ...
        <div class="widget-head">
          <h4 class="pull-left"><i class="icon-reorder"></i>Debtor's reports for <?php echo $bill_to_name;?></h4>
...
<?php
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Add new batch to '.$bill_to_name.'</h4>
					</div>
					
					<div class="modal-body">
					'.form_open("administration/reports/create_new_batch/".$bill_to_id, array("class" => "form-horizontal")).'
                    <div class="row">
		...
		if(!empty($search))
		{
			$result .= '<a href="'.site_url().'/administration/reports/close_debtors_search/'.$bill_to_id.'" class="btn btn-warning">Close Search</a>';
		}
				...
				'
					<table class="table table-hover table-bordered table-striped table-responsive col-md-12">
					  <thead>
						<tr>
						  <th>#</th>
						  <th><a href="'.site_url().'/administration/reports/debtors_report_data/'.$bill_to_id.'/batch_no/'.$order_method.'">Batch no.</a></th>
						  <th><a href="'.site_url().'/administration/reports/debtors_report_data/'.$bill_to_id.'/debtor_invoice_created/'.$order_method.'">Invoice date</a></th>
						  <th>Date range</th>
						  <th><a href="'.site_url().'/administration/reports/debtors_report_data/'.$bill_to_id.'/debtor_invoice_created_by/'.$order_method.'">Created by</a></th>
						  <th><a href="'.site_url().'/administration/reports/debtors_report_data/'.$bill_to_id.'/debtor_invoice_status/'.$order_method.'">Status</a></th>
						  <th>Total</th>
