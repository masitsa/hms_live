                          ...
                          <div class="center-align">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                	...
                                	<a href="<?php echo site_url().'/pharmacy/purchase_drug/'.$drugs_id;?>" class="btn btn-sm btn-success">Purchase Drug</a>
                                	<div class="table-responsive">
                                        <table border="0" class="table table-hover table-condensed">
                                           ...
                                           <tr>
                                                ...
                                                <td><a href="<?php echo site_url().'/pharmacy/edit_drug_purchase/'.$purchase_id.'/'. $drugs_id;?>" class="btn btn-sm btn-primary">Edit</a></td>
                                            </tr>
                                            <?php endforeach;?>
                                        </table>
                                	</div>
