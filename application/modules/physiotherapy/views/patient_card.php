...
?>
  ...
  <div class="center-align"> 
     <div class="col-md-3">
          <div class="center-align">
            <?php echo form_open("physiotherapy/send_to_pharmacy/".$visit_id, array("class" => "form-horizontal"));?>
        ...
        <div class="col-md-3">
          <div class="center-align">
           <?php echo form_open("physiotherapy/send_to_labs/".$visit_id, array("class" => "form-horizontal"));?>
        ...
        <div class="col-md-3">
          <div class="center-align">
            <?php echo form_open("physiotherapy/send_to_accounts/".$visit_id, array("class" => "form-horizontal"));?>
