...
<div class="row-fluid">
        ...
        <li><a href='<?php echo site_url('doctor/dental_queue')?>'>Doctor's Queue</a></li>
                   ...
                   <li><a href='<?php echo site_url('nurse/general_queue/5')?>'>General Queue</a></li>
                     <li><a href='<?php echo site_url('doctor/appointment_list1')?>'>Appointment List</a></li>
                    	<li><a href='<?php echo base_url('data/reports/dental.php')?>' target="_blank">Dental Reports</a></li>
