    ...
    <div class="col-md-12">
      ...
      <div class="widget boxed">
        ...
        <div class="widget-head">
          <h4 class="pull-left"><i class="icon-reorder"></i>Upcoming appointments</h4>
...
<?php
		$query = $this->reception_model->get_all_ongoing_visits3();
		$result = '';
		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				$patient_phone1 = $row->patient_phone2;
				$patient_number = $row->patient_phone1;
