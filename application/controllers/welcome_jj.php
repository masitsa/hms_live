...
function search_student($strath_no){
	...
	public function save_visit($patient_id)
	{
		...
		$this->form_validation->set_rules('service_charge_name', 'Consultation Type', 'required');
			...
			$patient_insurance_number = $this->input->post("insurance_id");
						$type_name = $this->input->post("patient_type"); 
		...
		else
		{
			...
			$this->save_visit_table($patient_id, $visit_date, $doc_name , $timepicker_start,$timepicker_end,$appointment_id, $visit_type, $patient_insurance_id,$patient_insurance_number,$close_card);
	...
	private function save_visit_table($patient_id, $visit_date, $doctor_id, $timepicker_start,$timepicker_end, $appointment_id, $visit_type, $patient_insurance_id,$patient_insurance_number,$close_card)
	{
			$insert = array(
