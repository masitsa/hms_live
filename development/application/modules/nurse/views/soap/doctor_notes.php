	        ...
	        <div class="form-group">
	            <div class="col-lg-12">
	                <div class="center-align">
	                      <a hred="#" class="btn btn-large btn-primary" onclick="save_doctor_notes('.$visit_id.')">Update Doctor Notes</a>
	                  </div>
	            </div>
	        </div>
	    </div>
	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="form-group">
	            <div class="col-lg-12">
	                <div class="center-align">
	                      <a hred="#" class="btn btn-large btn-success" onclick="save_doctor_notes('.$visit_id.')">Save Doctor Notes</a>
	                  </div>
	            </div>
	        </div>
	    </div>
