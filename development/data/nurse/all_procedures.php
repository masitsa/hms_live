...
<body>
	...
	if($s%2 == 0){
		...
		?>
        <form action="all_procedures.php" method="POST">
 ...
 <tr  bgcolor="<?php echo $bgcolor ?>">
	...
	<td><?php echo $visit_date ?></td>
        ...
        <?php } ?>
          ...
          <table align="center">
        		<tr>
            		<td><a href="all_procedures.php?id=<?php echo $previous_page; ?>" class="modify2"><img src="../../administration/images/back_alt.png"/></a></td>
            
            <?php
            
				for($t = 1; $t <= $num_pages; $t++){
					
					echo "<td width='10' ><a href='all_procedures.php?id=".$t."' class='modify'>".$t."</a></td>";
				}
			
			?>
            		<td><a href="all_procedures.php?id=<?php echo $next_page; ?>" class="modify2"><img src="../../administration/images/forward_alt.png"/></a></td>
           	  </tr>
            </table>
