...
if(isset($_GET['submit'])) {
	...
	?>
    <script>
	alert('<?php echo $month; ?>');
	</script>
    <?php
	echo $month;
	$get = new reports;
	$rs = $get->get_all_report_by_month($month);
	$num_rows = mysql_num_rows($rs);
}
?><html>
<head>
...
<body>
 <div id="header" class="container">
    	<div id="logo">
	    <h1><a href="#">SUMC</a></h1>
			<p><a href="http://www.strathmore.edu">General Accounting Report</a></p>
		</div>
	</div>
	<!-- end #header -->
	<div class="row-fluid">
    
    	<h3 class="page_title"> General Accounting Report  </h3>
    		<form action="reports.php" method="get" name="reports">
    			<table class="table table-striped">
    				<tr>
						...
						<td>Finish Date:<input type="text" id="datepicker1" name="finishdate"  autocomplete="off" /></td>
 						...
 						<td><a href="../pdfs/accounts.php?date1=<?php echo $date1?>&date2=<?php echo $date2?>&type=<?php echo $type?>" class="btn btn-success">Print</a> <td>
					</tr>
				</table>
...
';
	...
	?> </td><td><a href="http://sagana/hms/index.php/accounts/reports_invoice/<?php echo $visit_id ?>"> <?php echo $name.'		'.$secondname;?></a></td> <td><?php 
	if($dependant_id==0){
