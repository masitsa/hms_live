 ...
 <div id="header" class="container">
	...
	<div class="row-fluid">
    	...
    	<h3 class="page_title"> Accounting Summary Report  </h3>
    		<form action="lab.php" method="get" name="reports">
    			<table class="table table-striped">
    				<tr>
						...
						<td>Finish Date:<input type="text" id="datepicker1" name="finishdate"  autocomplete="off" /></td>
 						...
 						<td><a href="../pdfs/lab.php?date1=<?php echo $date1?>&date2=<?php echo $date2?>&type=<?php echo $type?>" class="btn btn-success">Print</a> <td>
					</tr>
				</table>
