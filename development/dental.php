<?php
        ...
        mysql_select_db("test", $connect)
			...
			$sql="SELECT * FROM service_dental ";
...
`drug_consumption_id` ,`quantity`)';*/
		$name= mysql_result($rs9, $s, "A");
		$insur  = mysql_result($rs9, $s, "B");
    $strath	= mysql_result($rs9, $s, "C");
...
//	$cost=str_replace(",", "", $cost1) ;
	...
	$visit_Type=4;
	$dd=($drugs_unitprice * 1.33);
	$sql2="INSERT INTO service_charge (service_charge_name,service_charge_amount,visit_type_id,service_id) VALUES ('$name','$insur', $visit_Type,9)";
echo $sql2.'<br />';
